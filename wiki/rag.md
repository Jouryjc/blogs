...
检索增强生成的工程实践:从把整个代码仓库变成可对话的知识图谱,到 RAG 系统里 TTFT(首 token 时延)的来源与优化手段。
...
- [[long-context-kv-cache|长上下文和 KV Cache:为什么上下文不是免费的]] · 见 [[prompt-caching]]
- [[wechat-drafts/2026-05-25-self-hosted-deep-research/article|Deep Research 最大坑:数据和流程都不在你手里]]〔草稿〕
- [[gitnexus-code-intelligence|GitNexus:把整个代码仓库变成可对话的知识图谱]]
...
- [[wechat-drafts/2026-05-25-self-hosted-deep-research/raw/source-normalized|Self-hosted Deep Research 原文(规范化)]]

## 相关主题

[[managed-agents]] · [[agent-runtime]] · [[prompt-caching]] · [[context-engineering]] · [[knowledge-base]]
