...
- **时间窗口**：Fable 5 附赠（免费）额度原定到 **2026 年 7 月 7 日**截止；主来源在 2026-07-14 更新，说明 Anthropic 后来把 included access 延到 **约 2026 年 7 月 12 日**。之后按 **$10 / 百万输入 token、$50 / 百万输出 token** 计费。
- **作者实测**：
  - 让 Fable 5 写了 **6 个技能**；
...
- **GitHub API 实测（2026-07-12）：22,300 stars、3,115 forks**；发布前复核（2026-07-15）：**22,626 stars、3,150 forks**。
  - 注意：周报（reports/x-hot-ai-agent-engineering/2026-07-12.md）写的 "5.2k+ stars" 与 API 实测不符，初稿采用 2026-07-12 API 实测的 **22.3k**。
  - 发布稿采用 2026-07-15 复核后的 **22.6k stars** 口径。
...
- 周报中 claude-skills "5.2k+ stars" 的数据已被 GitHub API 实测取代：初稿采用 2026-07-12 的 22.3k，发布稿采用 2026-07-15 的 22.6k；文章不使用 5.2k。
...
| 一天出圈 | 来源 5（周报） |
| Fable 5 附赠额度原定 7 月 7 日结束、后延到约 7 月 12 日；$10/M 输入、$50/M 输出 | 来源 1（2026-07-14 更新） |
...
| claude-skills 345 技能、22.6k stars、12 种智能体、18 领域 | 来源 3（2026-07-15 GitHub API 复核） |
