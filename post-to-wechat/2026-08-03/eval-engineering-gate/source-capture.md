# Source Capture: @hanakoxbt — Eval Engineering (full 6-step course)

- 作者: Hanako [@hanakoxbt](https://x.com/hanakoxbt)（Blue Verified，约 12.8k followers）
- 发布时间: 2026-08-01 13:08:21 GMT
- 原帖: https://x.com/hanakoxbt/status/2083540339147567268
- X Article: https://x.com/i/article/2083533144993488896
- 标题: Eval Engineering: build the gate that lets your agents merge without you (full 6-step course)
- 互动（2026-08-03 抓取快照）: ❤️ 413 · 🔁 63 · 💬 13 · 🔖 846 · 👁 156.7k
- 抓取方式: grok-research（X 线程抓取 + 公开页交叉核对）
