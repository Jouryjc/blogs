---
url: "https://x.com/akshay_pachaar/status/2031021906254766128"
...
1. Never switch models mid-session. Caches are model-specific. Switching to a cheaper model mid-conversation requires rebuilding the entire cache.
1. Never change the prefix to change the state. Instead, Claude Code adds a tag to the next user message that reminds the system. The prefix never changes.
