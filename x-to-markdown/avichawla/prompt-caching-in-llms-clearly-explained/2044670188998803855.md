---
url: "https://x.com/_avichawla/status/2044670188998803855"
requestedUrl: "https://x.com/_avichawla/status/2044670188998803855"
author: "Avi Chawla (@_avichawla)"
authorName: "Avi Chawla"
authorUsername: "_avichawla"
authorUrl: "https://x.com/_avichawla"
tweetCount: 1
coverImage: "imgs/img-010-HGAgHpOagAAq6Bq.jpg"
tags:
  - type/thread
...
![](imgs/img-001-HGAbx5qawAAzLuX.jpg)
...
![](imgs/img-002-HGAcaq1bwAAbUQ5.jpg)
...
![](imgs/img-003-HGAcKJha0AAh1G1.jpg)
...
![](imgs/img-004-HGAcWsnbMAAjZ3R.png)
...
![](imgs/img-005-HGAccolagAAztC1.jpg)
...
![](imgs/img-006-HGAcO8VbMAAEtV.jpg)
...
![](imgs/img-007-HGAcefoa0AAq71i.jpg)
...
![](imgs/img-008-HGAbt3ObkAAd1p4.jpg)
...
1. Don’t modify tools during a session. The tool definitions are part of the cached prefix, so adding or removing a tool invalidates everything downstream.
2. Never switch models mid-session. Caches are model-specific, which means switching to a cheaper model mid-conversation requires rebuilding the entire cache from scratch.
3. Never mutate the prefix to update state. Instead of editing the system prompt, Claude Code appends a reminder tag to the next user message so that the prefix stays untouched.
...
1. System instructions and behavioral rules at the top. Don’t change them mid-session.
2. Load all tool definitions upfront. Don’t add or remove them.
3. Retrieved context and reference documents next. Keep them stable for the session duration.
4. Conversation history and tool outputs at the bottom. This is your dynamic suffix.
...
![](imgs/img-009-HGAcY0MbMAA0wYN.jpg)
